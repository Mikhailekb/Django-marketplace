...
class CustomTestCase(TestCase):
  ...
  def setUpTestData(cls):
      ...
      cls.shop = Shop.objects.create(name=name, description=text, mail=email, address=address, slug=name, is_active=True)
      ...
      cls.product_shop = ProductShop.objects.create(product=cls.product, shop=cls.shop, count_left=100, count_sold=100,
